...
const SEO_FOTER = {
  ...
  uppsala: (() => {
    ...
    return '<footer id="seo-links" aria-label="Parkering i Uppsala">'
      ...
      + '<a href="/gratis-parkering-uppsala">Gratis parkering</a>'
      + '<a href="/billigare-parkering-uppsala">Billigare parkering</a>'
      + '<a href="/parkeringstid-uppsala">Hur länge får man stå?</a>'
